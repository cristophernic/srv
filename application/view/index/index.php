                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <?php if (Session::get("user_account_type") == 6) : ?>
                            ...
                            <li class="nav-item"><a class="nav-link" href="#" id="boton.departamentos">Unidad o departamentos</a></li>
      ...
      <style>
        ...
        $(document).ready(function() {
            ...
            $("#boton\\.configuracion").on("click", function(){
                ...
                $("#dialog\\.body").html('<ul class="nav nav-tabs" id="configuracionOption" role="tablist"><li class="nav-item"><a class="nav-link" data-toggle="tab" role="tab" aria-selected="false" id="departamento-tab" aria-controls="departamento" href="#a">Unidad o Departamento</a></li><li class="nav-item"><a class="nav-link active show" data-toggle="tab" role="tab" aria-selected="true" id="usuarios-tab" aria-controls="usuarios" href="#b">Usuarios</a></li></ul><div class="tab-content" id="configuracionTab"><div class="tab-pane fade" role="tabpanel" aria-labelledby="departamento-tab" id="a"><div role="group" aria-label="Botones" class="btn-group my-3"><button type="button" class="btn btn-outline-primary">Nuevo departamento</button><button type="button" class="btn btn-outline-primary">Guardar</button><button type="button" class="btn btn-outline-secondary">Cancelar</button></div><div class="row"><div class="col-12" id="departamento.formulario"><div class="card my-2"><div class="card-body"><h5 class="card-title text-right">Nuevo Departamento</h5><div class="form-group"><label for="departamento.formulario.texto">Nombre del departamento</label><input class="form-control" type="text" id="departamento.formulario.texto"></div><div class="form-group"><label for="departamento.formulario.jefe">Jefe de departamento</label><select class="form-control" id="departamento.formulario.jefe"></select></div></div></div></div><div class="col-12"><table class="table"><thead class="thead-dark"><tr><th scope="col">#</th><th scope="col">Nombre del departamento</th><th scope="col">Jefe</th><th scope="col">N° Integrantes</th><th scope="col">acciones</th></tr></thead><tbody id="departamentos.tabla"></tbody></table></div></div></div><div class="tab-pane fade active show" role="tabpanel" aria-labelledby="usuarios-tab" id="b"><div role="group" aria-label="Botones" class="btn-group my-3"><button type="button" class="btn btn-outline-primary">Asignar usuario a un departamento</button><button type="button" class="btn btn-outline-primary">Guardar</button><button type="button" class="btn btn-outline-secondary">Cancelar</button></div><div class="row"><div class="col-12" id="usuarios.formulario"><div class="card my-2"><div class="card-body"><h5 class="card-title text-right">Usuario a Departamento</h5><div class="form-group"><label for="usuario.formulario.usuario">Profesional</label><select class="form-control" id="usuario.formulario.usuario"></select></div><div class="form-group"><label for="usuario.formulario.departamento">Departamento</label><select class="form-control" id="usuario.formulario.departamento"></select></div></div></div></div><div class="col-12"><div class="form-group"><label for="usuarios.departamento.filtrar">Departamento</label><select class="form-control" id="usuarios.departamento.filtrar"></select></div><table class="table"><thead class="thead-dark"><tr><th scope="col">#</th><th scope="col">Departamento</th><th scope="col">Nombre profesional</th><th scope="col">Telefono</th><th scope="col">Correo</th><th scope="col">acciones</th></tr></thead><tbody id="usuarios.tabla"></tbody></table></div></div></div></div>');
                $("#dialog\\.view").modal("show");
                $("#dialog\\.delete").remove();
            })
