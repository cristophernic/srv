...
return array(
    ...
    "FEEDBACK_USERNAME_FIELD_EMPTY" => "El nombre de usuario está vacio.",
    ...
    "FEEDBACK_USER_EMAIL_ALREADY_TAKEN" => "este correo ya está registrado, intente cambiar la contraseña.",
