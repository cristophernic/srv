...
class TurnosModel
{
    ...
    public static function getAllProfesionales()
    {
        ...
        if (Session::get("user_account_type") == 6){
            ...
            $profesional_id = $profesional_id->profesional_id;
            $sql = "SELECT profesional_id, profesional_name, profesional_rut, profesional_telefono, profesional_correo FROM profesionales WHERE NOT profesional_id = :profesional_id";
            $query = $database->prepare($sql);
