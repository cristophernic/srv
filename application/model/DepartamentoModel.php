...
class DepartamentoModel
{
    ...
    public static function getDepartamento($departamento_id)
    {
        ...
        $sql = "SELECT departamentos.departamento_id, departamentos.departamento_name, departamentos.departamento_jefe users.user_nombre FROM departamentos WHERE departamentos.departamento_id = :departamento_id INNER JOIN users ON (departamentos.departamento_jefe = users.user_id) LIMIT 1";
        $query = $database->prepare($sql);
